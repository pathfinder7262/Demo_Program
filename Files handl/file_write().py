...
with open("file8.data","w") as chetanp:
    ...
    print("="*50)
    chetanp.write("This is my first program using write() function\n")
    chetanp.write("This is my first program using write() function line 2\n")
    chetanp.write("This is my first program using write() function line 3\n")
    chetanp.write( str(4323)+"\n")
